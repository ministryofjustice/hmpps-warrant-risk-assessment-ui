context('Basic Details page', () => {
  it('can see readonly fields', () => {
    ...
    cy.get('#address').should('contain.text', 'MainDistrict')
    cy.get('#address').should('contain.text', 'Maintown')
    cy.get('#address').should('contain.text', 'Maincounty')
    cy.get('#address').should('contain.text', 'MA30 3IN')
    cy.get('#date-of-home-visit').should('contain.text', '17/03/2025')
    cy.get('#other-address-1').should('contain.text', '281 Postal Default Street')
    cy.get('#other-address-1').should('contain.text', 'Postrict')
    cy.get('#other-address-1').should('contain.text', 'Postinton')
    cy.get('#other-address-1').should('contain.text', 'County Post')
    cy.get('#other-address-1').should('contain.text', 'NE30 3ZZ')
