context('Basic Details page', () => {
  it('can see readonly fields', () => {
    ...
    cy.get('#employer-address-1').should('contain.text', 'Billy The Kid')
    cy.get('#employer-address-1').should('contain.text', '281 Postal Default Street')
    cy.get('#employer-address-1').should('contain.text', 'Postrict')
    cy.get('#employer-address-1').should('contain.text', 'Postinton')
    cy.get('#employer-address-1').should('contain.text', 'County Post')
    cy.get('#employer-address-1').should('contain.text', 'NE30 3ZZ')
    cy.get('#employer-address-2').should('contain.text', 'John Dun Dee')
    cy.get('#employer-address-2').should('contain.text', 'MainName')
    cy.get('#employer-address-2').should('contain.text', '396 Main Default Street')
    cy.get('#employer-address-2').should('contain.text', 'Test City')
    cy.get('#employer-address-2').should('contain.text', 'Test District')
    cy.get('#employer-address-2').should('contain.text', 'County County')
    cy.get('#employer-address-2').should('contain.text', 'NE31 3YY')
